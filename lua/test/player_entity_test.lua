...
describe("PlayerEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MLBGUMBO_TEST_PLAYER_ENTID JSON to run live")
      return
    end
...
function player_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MLBGUMBO_TEST_PLAYER_ENTID")
