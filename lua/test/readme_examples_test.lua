...
local SDK_MODULE = "mlb-gumbo_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["game_data"] = { ["test01"] = { id = "test01" } }, ["player"] = { ["test01"] = { id = "test01" } }, ["schedule"] = { ["test01"] = { id = "test01" } }, ["team"] = { ["test01"] = { id = "test01" } } } }'
