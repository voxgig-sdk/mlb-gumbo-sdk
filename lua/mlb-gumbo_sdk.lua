...
local MlbGumboSDK = {}
MlbGumboSDK.__index = MlbGumboSDK
...
MlbGumboSDK._make_feature = _make_feature


function MlbGumboSDK.new(options)
  local self = setmetatable({}, MlbGumboSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function MlbGumboSDK:options_map()
...
function MlbGumboSDK:get_utility()
  return Utility.copy(self._utility)
end


function MlbGumboSDK:get_root_ctx()
  return self._rootctx
end


function MlbGumboSDK:prepare(fetchargs)
...
function MlbGumboSDK:direct(fetchargs)
...
-- by passing it.
function MlbGumboSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function MlbGumboSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "MlbGumboSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function MlbGumboSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = MlbGumboSDK.new(sdkopts)
  sdk.mode = "test"
