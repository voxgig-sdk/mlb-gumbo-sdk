...
| --- | --- | --- | --- |
| `gameData` | `Hash` | No | Metadata about the game including teams, venue, and game status |
| `liveData` | `Hash` | No | Real-time game data including plays, boxscore, and current state |
