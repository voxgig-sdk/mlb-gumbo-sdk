...
class ScheduleEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MLB_GUMBO_TEST_SCHEDULE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def schedule_basic_setup(extra)
  ...
  entid_env_raw = ENV["MLB_GUMBO_TEST_SCHEDULE_ENTID"]
