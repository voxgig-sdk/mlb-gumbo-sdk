...
type Args struct {
	Entity string         `json:"entity" jsonschema:"game_data | player | schedule | team"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MlbGumboSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "mlb-gumbo_list",
		Description: "List records from MlbGumbo. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "mlb-gumbo_load",
		Description: "Load a single record from MlbGumbo. " +
...
func runOp(client *sdk.MlbGumboSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MlbGumboSDK, name string) (sdk.MlbGumboEntity, error) {
	switch strings.ToLower(name) {
	case "game_data":
		return client.GameData(nil), nil
	case "player":
