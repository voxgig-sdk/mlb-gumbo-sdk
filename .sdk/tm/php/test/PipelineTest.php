...
{
    private static function utility(): MlbGumboUtility
    {
        return new MlbGumboUtility();
    }
    ...
    private static function ctx(array $over = []): MlbGumboContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MlbGumboContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MlbGumboOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MlbGumboError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MlbGumboOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MlbGumboMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MlbGumboOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MlbGumboMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MlbGumboOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MlbGumboMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MlbGumboSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MlbGumboMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MlbGumboResponse([]),
            'result' => new MlbGumboResult([]),
        ]);
        [, $err] = MlbGumboMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MlbGumboSpec([]),
            'response' => null,
            'result' => new MlbGumboResult([]),
        ]);
        [, $err] = MlbGumboMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MlbGumboSpec(['step' => 's']),
            'response' => new MlbGumboResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MlbGumboResult([]),
        ]);
        [, $err] = MlbGumboMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MlbGumboSpec(['step' => 's']),
            'response' => new MlbGumboResponse(self::resp(200, ['v' => 1])),
            'result' => new MlbGumboResult([]),
        ]);
        [, $err] = MlbGumboMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MlbGumboSpec(['step' => 's']),
            'response' => new MlbGumboResponse(self::resp(200, ['v' => 2])),
            'result' => new MlbGumboResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MlbGumboMakeResponse::call($ctx);
    ...
    {
        $preset = new MlbGumboResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MlbGumboSpec([]),
            'response' => new MlbGumboResponse([]),
            'result' => new MlbGumboResult([]),
        ...
        [$got, $err] = MlbGumboMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MlbGumboResult([])]);
        [, $err] = MlbGumboMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MlbGumboSpec([]), 'result' => null]);
        [, $err] = MlbGumboMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MlbGumboSpec(['step' => 's']),
            'result' => new MlbGumboResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MlbGumboOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MlbGumboMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MlbGumboSpec(['step' => 's']),
            'result' => new MlbGumboResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MlbGumboOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MlbGumboMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MlbGumboResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MlbGumboSpec([]),
            'result' => new MlbGumboResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MlbGumboMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MlbGumboMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MlbGumboError('boom', 'boom');
        $utility->fetcher = function (MlbGumboContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MlbGumboSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MlbGumboMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MlbGumboContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MlbGumboMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MlbGumboResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MlbGumboContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MlbGumboSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MlbGumboMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MlbGumboResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MlbGumboSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MlbGumboMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MlbGumboMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MlbGumboMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MlbGumboResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MlbGumboDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MlbGumboResult(['ok' => false])]);
        $this->expectException(MlbGumboError::class);
        MlbGumboDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MlbGumboResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MlbGumboMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MlbGumboMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MlbGumboBaseFeature();
        $b = new MlbGumboBaseFeature();
        MlbGumboFeatureAdd::call($ctx, $a);
        MlbGumboFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MlbGumboBaseFeature
    {
        $f = new MlbGumboBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MlbGumboFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MlbGumboContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MlbGumboSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MlbGumboPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MlbGumboResponse(['headers' => null]),
            'result' => new MlbGumboResult([]),
        ]);
        MlbGumboResultHeaders::call($ctx);
