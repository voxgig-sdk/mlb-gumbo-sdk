...
// MlbGumbo SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MlbGumboMakeRequest
{
    public static function call(MlbGumboContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MlbGumboResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MlbGumboResponse($fetched);
        } else {
