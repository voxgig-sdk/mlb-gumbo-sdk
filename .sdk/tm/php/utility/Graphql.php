...
class MlbGumboGraphql
{
    ...
    // equivalent.
    public static function body(MlbGumboContext $ctx): mixed
    {
    ...
    public static function errors(MlbGumboContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
