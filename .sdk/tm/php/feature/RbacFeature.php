...
class MlbGumboRbacFeature extends MlbGumboBaseFeature
{
    ...
    private function _required(MlbGumboContext $ctx): ?string
    {
    ...
    private function _reject(MlbGumboContext $ctx, string $required): void
    {
    ...
    private function _track(MlbGumboContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
