...
// MlbGumbo SDK clienttrack feature
...
class MlbGumboClienttrackFeature extends MlbGumboBaseFeature
{
    ...
    public function PostConstruct(MlbGumboContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MlbGumbo-SDK';
