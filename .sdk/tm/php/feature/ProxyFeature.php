...
class MlbGumboProxyFeature extends MlbGumboBaseFeature
{
    ...
    public function init(MlbGumboContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MlbGumboContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
