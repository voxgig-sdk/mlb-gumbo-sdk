...
describe('exists', async () => {
  ...
  //
  // MlbGumboSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof MlbGumboSDK, true,
      'MlbGumboSDK.test() must return a client synchronously')
  })
