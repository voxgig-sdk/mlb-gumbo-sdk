...
from mlbgumbo_sdk.core.control import MlbGumboControl
...
from mlbgumbo_sdk.core.helpers import get_ctx_prop, to_map
...
class MlbGumboContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, MlbGumboResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MlbGumboResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MlbGumboError(code, msg, self)
