...
from mlbgumbo_sdk.utility import register

# Load features
from mlbgumbo_sdk.feature.base_feature import MlbGumboBaseFeature
from mlbgumbo_sdk.features import _has_feature, _make_feature
...
class MlbGumboSDK:
    ...
    def get_utility(self):
        return MlbGumboUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MlbGumboSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GameData(self, data=None) -> "GameDataEntity":
        ...
        from mlbgumbo_sdk.entity.game_data_entity import GameDataEntity
    ...
    def Player(self, data=None) -> "PlayerEntity":
        ...
        from mlbgumbo_sdk.entity.player_entity import PlayerEntity
    ...
    def Schedule(self, data=None) -> "ScheduleEntity":
        ...
        from mlbgumbo_sdk.entity.schedule_entity import ScheduleEntity
        return ScheduleEntity(self, data)


    def Team(self, data=None) -> "TeamEntity":
        """Entity factory: client.Team().list() / client.Team().load({"id": ...})."""
        from mlbgumbo_sdk.entity.team_entity import TeamEntity
