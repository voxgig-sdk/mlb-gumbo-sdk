...
from mlbgumbo_sdk.core.spec import MlbGumboSpec
from mlbgumbo_sdk.core.result import MlbGumboResult
from mlbgumbo_sdk.core.response import MlbGumboResponse
from mlbgumbo_sdk.core.operation import MlbGumboOperation
from mlbgumbo_sdk.core.error import MlbGumboError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = MlbGumboSDK.test(None, None)
        ...
        class TestInitFeature(MlbGumboBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MlbGumboBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MlbGumboSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MlbGumboSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MlbGumboSDK.test(None, setup_opts)
