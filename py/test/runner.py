...
class MlbGumboTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MlbGumboTestRunner.getenv("MLBGUMBO_TEST_LIVE")
        override = MlbGumboTestRunner.getenv("MLBGUMBO_TEST_OVERRIDE")
        ...
        explain = MlbGumboTestRunner.getenv("MLBGUMBO_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["MLBGUMBO_TEST_EXPLAIN"] = explain
