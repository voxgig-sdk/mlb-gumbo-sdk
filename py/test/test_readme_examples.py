# MlbGumbo SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MlbGumboSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MlbGumboSDK(...) and MlbGumboSDK.test(...) become
#      MlbGumboSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mlbgumbo_sdk"
_SDK_CLASS = "MlbGumboSDK"
