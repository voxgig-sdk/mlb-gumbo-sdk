...
const testSeed = `map[string]any{"entity": map[string]any{"game_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "player": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "team": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
