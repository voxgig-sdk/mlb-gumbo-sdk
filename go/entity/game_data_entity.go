...
func NewGameDataEntity(client *core.MlbGumboSDK, entopts map[string]any) *GameDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GameDataEntity) GetName() string { return e.name }
...
func (e *GameDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GameDataEntity) Deleted() bool {
	return e.deleted
}


func (e *GameDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGameDataEntity(e.client, opts)
}

func (e *GameDataEntity) Data(args ...any) any {
...
func (e *GameDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GameData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GameDataEntity) DataTyped(data ...GameData) GameData {
	if len(data) > 0 {
		return typedFrom[GameData](e.Data(asMap(data[0])))
	}
	return typedFrom[GameData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GameData (all fields
// optional at the wire level).
func (e *GameDataEntity) MatchTyped(match ...GameData) GameData {
	if len(match) > 0 {
		return typedFrom[GameData](e.Match(asMap(match[0])))
	}
	return typedFrom[GameData](e.Match())
}
...
func (e *GameDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GameDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GameDataLoadMatch and returns an GameData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GameDataEntity) LoadTyped(reqmatch GameDataLoadMatch, ctrl map[string]any) (GameData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GameData{}, err
	}
	return typedFrom[GameData](res), nil
}




func (e *GameDataEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// GameDataListMatch and returns []GameData. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GameDataEntity) ListTyped(reqmatch GameDataListMatch, ctrl map[string]any) ([]GameData, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GameData](res), nil
}



func (e *GameDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GameDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GameDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GameDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
