...
// MlbGumbo SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MlbGumboSDK::test)
...
{
    private const SDK_CLASS = 'MlbGumboSDK';
    ...
    private const SDK_BASE = 'mlbgumbo_sdk';
