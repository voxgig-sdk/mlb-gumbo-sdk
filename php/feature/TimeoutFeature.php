...
class MlbGumboTimeoutFeature extends MlbGumboBaseFeature
{
    ...
    private function _with_timeout(MlbGumboContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MlbGumboContext $_ctx, float $ms): void
    {
        $client = $this->client;
