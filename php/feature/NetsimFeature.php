...
class MlbGumboNetsimFeature extends MlbGumboBaseFeature
{
    ...
    private function _simulate(MlbGumboContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MlbGumboContext $ctx, array $applied): void
    {
        $client = $this->client;
