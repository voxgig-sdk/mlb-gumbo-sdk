...
// MlbGumbo SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MlbGumboTestFeature extends MlbGumboBaseFeature
{
    ...
    public function init(MlbGumboContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MlbGumboContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MlbGumboContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MlbGumboContext $ctx, $op, $args): array
    {
