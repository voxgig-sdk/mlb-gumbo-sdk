...
class MlbGumboCacheFeature extends MlbGumboBaseFeature
{
    ...
    private function _through(MlbGumboContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
