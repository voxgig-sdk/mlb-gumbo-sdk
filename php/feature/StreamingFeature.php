...
// MlbGumbo SDK streaming feature
...
class MlbGumboStreamingFeature extends MlbGumboBaseFeature
{
    ...
    private function _iterate(MlbGumboResult $result): \Generator
    {
    ...
    private function _streamable(MlbGumboContext $ctx): bool
    {
