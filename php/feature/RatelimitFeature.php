...
// MlbGumbo SDK ratelimit feature
...
class MlbGumboRatelimitFeature extends MlbGumboBaseFeature
{
    ...
    private function _acquire(MlbGumboContext $ctx): void
    {
    ...
    private function _track(MlbGumboContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
