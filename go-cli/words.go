...
func registerSDKWords(r *eng.Registry, client *sdk.MlbGumboSDK) {
...
func runOp(client *sdk.MlbGumboSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
